...
.PHONY: testnet-lean
testnet-lean: genesis build-docker ## Start a local testnet with the lean payment lane (host lean nodes + localdev-lean.toml)
...
testnet-lean-status: ## Heights and lean block agreement across the lean testnet
