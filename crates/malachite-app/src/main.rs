...
fn start(args: &Args, cmd: &StartCmd, logging: config::LoggingConfig) -> Result<()> {
    ...
    let start_config = StartConfig {
        ...
        payment_eth_socket: cmd.payment_eth_socket.clone(),
        payment_execution_socket: cmd.payment_execution_socket.clone(),
        payment_eth_rpc_endpoint: cmd.payment_eth_rpc_endpoint.clone(),
        payment_execution_endpoint: cmd.payment_execution_endpoint.clone(),
        payment_execution_ws_endpoint: cmd.payment_execution_ws_endpoint.clone(),
        payment_execution_jwt: cmd.payment_execution_jwt.clone(),
